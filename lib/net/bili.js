...
const bili_client = {
    ...
    _getOneDynamicByDyid: new Line('获取一个动态的细节', [
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V11,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V13,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V14,
            config: { retry: false },
            query: {
                dynamic_id
            }
        ...
        (dynamic_id) => get({
            url: API.DYNAMIC_SVR_GET_DYNAMIC_DETAIL_V16,
            config: { retry: false },
            query: {
                dynamic_id
            }
