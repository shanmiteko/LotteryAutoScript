    ...
    async filterLotteryInfo() {
        ...
        for (const info of protoLotteryInfo) {
            ...
            if (hasOfficialLottery && model[0] === '1') {
                ...
                if (followerNum < Number(minfollower))
                    continue;
            ...
            if (isLottery) {
                ...
                if (reg1.test(blacklist) || reg2.test(blacklist))
                    continue;
                /* 判断是否关注过 */
                ...
                if (typeof onelotteryinfo.uid === 'undefined' && typeof onelotteryinfo.dyid === 'undefined')
                    continue;
