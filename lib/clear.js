...
async function clear() {
    ...
    const { clear_max_day, clear_remove_all_force, clear_remove_dynamic, clear_remove_attention, clear_remove_delay, clear_dynamic_type } = config;
    ...
    for (let index = 0; index < 1000; index++) {
        ...
        for (let index = 0; index < allModifyDynamicResArray.length; index++) {
            ...
            if (clear_remove_all_force || type === clear_dynamic_type) {
